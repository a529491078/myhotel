    ...
    <div class="dept_info col-sm-10">
        <div class="panel panel-success">
            ...
            <div class="panel-heading">
                <ol class="breadcrumb">
                    <li><a href="#">顾客管理</a></li>
                    <li class="active">添加顾客信息</li>
                </ol>
            </div>
            <div class="modal-header">
                <h4 class="modal-title">顾客新增</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal add_customer_info_form" onsubmit="return false">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="customerNickName" class="form-control" id="add_customerNickName" placeholder="如：a5294">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="checkbox">
                                <select class="form-control" name="customerSex" id="add_customerSex">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="customerAddress" class="form-control" id="add_customerAddress" placeholder="如：福建宁德##">
                            <span class="help-block"></span>
                        </div>
                    </div>
                </form>
...
$(function(){
	...
	var code=false;
    //昵称框失去焦点时
	 $("#add_customerNickName").blur(function(){
		 if($(this).val()== ''){
    ...
    //地址框失去焦点时
	 $("#add_customerAddress").blur(function(){
		 if($(this).val()== ''){
				$(this).next().css("color","red").html("X");
	 ...
	 $(".customerInfo_save_btn").click(function(){
		 $.post("get_not_customer_info_byid",$(".add_customer_info_form").serialize(),function (result) {
				if(result.code==400){
					code=false;
				}else{
					code=true;
				...
				if(code==false){
					...
					if(customerNickName==true&&customerName==true&&customerPhone==true
                        &&customerId==true&&customerAddress==true){
						 $.post("ins_customer_info",$(".add_customer_info_form").serialize(),function (result) {
							if(result.code==200){
								alert(result.msg);
								 window.location.href="get_customer_info_page";
							}else{
								alert(result.msg);
								window.location.href="add_customer_info";
							}
						 });
					 }else{
						 alert("请添加完整信息");
